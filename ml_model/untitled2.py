...
# Step 1: Load CSV (replace with correct local path)
csv_path = 'adapter_info.csv'  # Make sure this file is in your working directory
...
# ------------- RUN IT LOCALLY WITH AN IMAGE -------------
if __name__ == "__main__":
    image_path = input("Enter path to image file (e.g. test.jpg): ").strip()
